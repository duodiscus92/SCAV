...
AbstractionLayer::AbstractionLayer( const bool ignore_steering,
...
/*************************************************************************/
  ...
  // create motor listener and data reader
...
{
  AbstractionLayer::ignore_motor_ = ignore_motor;
  AbstractionLayer::ignore_steering_ = ignore_steering;
}
